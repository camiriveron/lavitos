	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			<?php 
				...
				previous_post_link( '<div class="nav-previous">%link</div>', _x( '<h3 class="widget-title">Historia Anterior</h3><div class="scale__image__wrapper">'.$prevThumbnail.'</div><div><span class="meta-nav"></span>&nbsp;%title</div>', 'Previous post link', 'sela' ) );

				$nextPost = get_next_post(true); 
				$nextThumbnail = get_the_post_thumbnail($nextPost->ID, array(150,150) ); 
				next_post_link('<div class="nav-next">%link</div>',     _x( '<h3 class="widget-title">Siguiente historia</h3><div class="scale__image__wrapper">'.$nextThumbnail.'</div><div>%title&nbsp;<span class="meta-nav"></span></div>', 'Next post link', 'sela' ) );
			?>
