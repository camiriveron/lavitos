	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			<?php 
				...
				previous_post_link( '<div class="nav-previous"><h3 class="widget-title">Historia anterior</h3>%link</div>', _x( $prevThumbnail.'<div><span class="meta-nav"></span>&nbsp;%title</div>', 'Previous post link', 'sela' ) );

				$nextPost = get_next_post(true); 
				$nextThumbnail = get_the_post_thumbnail($nextPost->ID, array(150,150) ); 
				next_post_link('<div class="nav-next"><h3 class="widget-title">Siguiente historia</h3>%link</div>',     _x( $nextThumbnail.'<div>%title&nbsp;<span class="meta-nav"></span></div>', 'Next post link', 'sela' ) );
			?>
